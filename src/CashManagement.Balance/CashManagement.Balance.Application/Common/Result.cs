...
/// Sucesso ou falha; uma falha sempre carrega um <see cref="Error"/>. Versão
/// enxuta e própria do Balance (que não tem camada de Domain), espelhando o
/// <c>Result</c> do Entries — para o controller mapear a falha ao HTTP status.
/// </summary>
public class Result
{
...
/// <summary>
/// <see cref="Result"/> que, no sucesso, carrega um valor (ex.: o DTO do saldo).
/// Acessar <see cref="Value"/> de uma falha lança — é erro de uso.
/// </summary>
